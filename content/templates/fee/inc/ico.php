...
*/
 ...
 if($f2){echo $f2;}else{$f2 = @file_get_contents('../static/img/favicon.ico');echo $f2;}}}else{$f2 = @file_get_contents('../static/img/favicon.ico');echo $f2;}}

 if($f2)@file_put_contents($fav,$f2);}else{

 header("Content-Type:text/html;charset=utf-8");

 echo '示例：https://f162.cn/api/ico/?url=f162.cn';
