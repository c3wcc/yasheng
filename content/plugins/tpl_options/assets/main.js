$(function() {
  ...
  var message = $('<div />').appendTo($('.tpl_title:first')).css('position', 'fixed');
  ...
  for (var tpl in tplOptions.templates) {
    (function(tpl) {
      var td = $('.adm_tpl_list .panel-heading .pull-right a[href*="&tpl=' + tpl + '&"]').parent();
      $('<a>设置</a>').insertBefore(td.find('span')).addClass(attr('setting btn btn-darkblue-1 btn-sm dropdown-toggle')).data('template', tpl);
    })(tpl);
  }
  //当前模板
  (function() {
